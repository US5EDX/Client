...
namespace Client.Models
{
    public partial class GroupFullInfo : ObservableObject
    {
        ...
        public void UpdateInfo(GroupFullInfo groupInfo)
        {
            GroupCode = groupInfo.GroupCode;
            Specialty = groupInfo.Specialty;
            Course = groupInfo.Course;
            EduLevel = groupInfo.EduLevel;
            ...
            HasEnterChoise = groupInfo.HasEnterChoise;
            ChoiceDifference = groupInfo.ChoiceDifference;
            CuratorInfo = groupInfo.CuratorInfo;
        }
    }
}
