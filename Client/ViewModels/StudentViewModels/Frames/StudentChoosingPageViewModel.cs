...
{
    public partial class StudentChoosingPageViewModel : FrameBaseViewModel
    {
        ...
        public List<DisciplineComboBoxViewModel> OddSemesterChoices { get; init; } = null!;
        public List<DisciplineComboBoxViewModel> EvenSemesterChoices { get; init; } = null!;
